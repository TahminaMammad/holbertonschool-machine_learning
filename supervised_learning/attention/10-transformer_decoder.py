#!/usr/bin/env python3
"""Module for the Transformer decoder."""
...
class Decoder(tf.keras.layers.Layer):
    ...
    def __init__(self, N, dm, h, hidden, target_vocab,
        ...
        Args:
            ...
            hidden: Number of hidden units in the dense layer.
    ...
    def call(self, x, encoder_output, training,
        ...
        """Calculate the output of the Transformer decoder.

        Args:
            x: Target word indices with shape
                (batch, target_seq_len).
            encoder_output: Encoder output with shape
