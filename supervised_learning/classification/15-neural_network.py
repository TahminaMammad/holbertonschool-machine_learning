#!/usr/bin/env python3
"""Module that defines a neural network with one hidden layer and advanced training"""
...
class NeuralNetwork:
    ...
    def forward_prop(self, X):
        """Perform forward propagation using sigmoid activations"""
    ...
    def train(self, X, Y, iterations=5000, alpha=0.05,
        ...
        for i in range(iterations + 1):
            ...
            if i < iterations:  # avoid extra gradient step at last iteration
