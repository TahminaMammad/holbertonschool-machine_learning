...
class NST:
    ...
    def scale_image(image):
        """Scale image to [0,1] and max size 512."""
    ...
    def load_model(self):
        """Load VGG19 model with avg pooling instead of max pooling."""
    ...
    def generate_features(self):
        """Generate style and content features."""

        style = self.style_image * 255.0
        content = self.content_image * 255.0
    ...
    def layer_style_cost(self, style_output, gram_target):
        """Compute single layer style cost."""
