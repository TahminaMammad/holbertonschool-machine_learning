...
class Dataset:
    """Load, tokenize, and encode a machine translation dataset."""

    def __init__(self):
        """Load the datasets, create tokenizers, and encode all examples."""
    ...
    def tokenize_dataset(self, data):
        """Create Portuguese and English tokenizers from the training data."""
    ...
    def encode(self, pt, en):
        """Encode a Portuguese-English pair with start and end tokens."""
    ...
    def tf_encode(self, pt, en):
        """Wrap encode as a TensorFlow operation and set output shapes."""
